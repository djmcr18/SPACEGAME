...
void update_player(player_data &player)
{
    ...
    double left_edge = camera_x() + SCREEN_BORDER + 125;
    double right_edge = left_edge + screen_width() - 2 * SCREEN_BORDER - 250;
    double top_edge = camera_y() + SCREEN_BORDER + 125;
    double bottom_edge = top_edge + screen_height() - 2 * SCREEN_BORDER - 250;
